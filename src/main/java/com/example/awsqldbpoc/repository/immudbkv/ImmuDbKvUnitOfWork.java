...
@Profile("immudbkv")
@Service
public class ImmuDbKvUnitOfWork implements UnitOfWork {

	private final ObjectPool<ImmuClient> immuClientPool;
	private final IBalanceRepository balanceRepository;
	private final ITransactionRepository transactionRepository;

	public ImmuDbKvUnitOfWork(ObjectPool<ImmuClient> immuClientPool, IBalanceRepository balanceRepository,
